      ...
      <section className="bg-white text-slate-900 py-20 relative overflow-hidden border-b border-slate-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          ...
          <p className="text-xl text-slate-500 max-w-3xl mx-auto leading-relaxed font-medium">
            Eurofins DiscoverX® 提供业内最为丰富的功能性细胞系资源库，包含 1,000 多种经过充分验证的细胞系。
          </p>
        </div>
      </section>

      {/* 2. Introduction & Application Areas - Green Card Style */}
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid md:grid-cols-2 gap-16 items-stretch">
          <div className="space-y-6 text-slate-600 leading-relaxed text-justify flex flex-col justify-center">
          ...
          {/* Green Focal Card */}
          <div className="bg-[#4B827E] p-10 rounded-[2.5rem] shadow-2xl text-white relative overflow-hidden">
            <div className="absolute top-0 right-0 w-40 h-40 bg-white/5 rounded-full -mr-20 -mt-20 blur-3xl"></div>
            <h3 className="text-2xl font-bold mb-8 flex items-center">
              <svg className="w-6 h-6 mr-3 text-teal-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="flex flex-wrap gap-2 mb-10">
              {targetCategories.map((cat, idx) => (
                <button
                  ...
                  className="px-4 py-2 bg-white/10 backdrop-blur-md border border-white/20 rounded-xl text-xs font-bold text-white hover:bg-white hover:text-[#4B827E] transition-all shadow-sm"
                >
                  {cat.name}
                </button>
              ))}
            ...
            <div className="space-y-4">
               <p className="text-[10px] uppercase font-black tracking-[0.2em] text-teal-200 mb-2">主要治疗领域支持</p>
               <ul className="grid grid-cols-2 gap-4 text-xs font-medium text-teal-50">
          ...
          <div className="space-y-6 max-w-5xl mx-auto">
            ...
            <div className="bg-white p-8 rounded-[2rem] border border-slate-200 shadow-sm flex flex-col md:flex-row gap-10 items-start group hover:border-[#4B827E] transition-all">
              ...
              <div className="flex-grow">
                <h4 className="text-xl font-bold text-[#1C2C5E] mb-3">细胞系检测套装 (Cell Line Assay Kit)</h4>
                <p className="text-sm text-slate-500 mb-3 leading-relaxed">DiscoverX 大部分稳转细胞系均以套装形式供应。一个套装包含：</p>
                <div className="bg-slate-50/50 rounded-xl p-5 border border-slate-100">
                  <ul className="text-sm text-slate-700 space-y-2 font-semibold">
                    <li className="flex items-center gap-3">
                      <span className="w-1.5 h-1.5 bg-[#4B827E] rounded-full"></span>
                      两管可传代稳转细胞系、
                    </li>
                    <li className="flex items-center gap-3">
                      <span className="w-1.5 h-1.5 bg-[#4B827E] rounded-full"></span>
                ...
                <div className="flex gap-4 mt-6">
                  <span className="text-[10px] font-bold text-[#4B827E] bg-teal-50 px-3 py-1.5 rounded-lg border border-teal-100">10代稳定性验证</span>
                  <span className="text-[10px] font-bold text-[#4B827E] bg-teal-50 px-3 py-1.5 rounded-lg border border-teal-100">HTS兼容</span>
                </div>
              </div>
            </div>
            {/* Format 2 */}
