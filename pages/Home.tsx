  ...
  return (
    <div className="space-y-12 pb-20">
      ...
      <section className="relative h-[250px] flex items-center justify-center text-white overflow-hidden">
        ...
        <img 
          src="https://picsum.photos/seed/hero-science/1920/1080" 
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {sortedPosts.map(post => (
            <div 
              key={post.id} 
              className={`group bg-white rounded-lg overflow-hidden shadow-sm hover:shadow-md transition-all duration-300 border ${
            ...
            >
              ...
              <div className="p-6">
                ...
                <div className="flex justify-between items-center">
                  <button className="text-[#4B827E] font-bold text-xs flex items-center group-hover:translate-x-1 transition-transform uppercase tracking-wider">
