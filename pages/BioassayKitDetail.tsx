      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="flex flex-col md:flex-row gap-12 items-center">
          <div className="md:w-1/2">
            <h1 className="text-4xl font-extrabold text-[#1C2C5E] mb-6">一、Bioassay Kits 介绍</h1>
          ...
          <div className="md:w-1/2">
            <div className="relative">
              <img src="https://picsum.photos/seed/bioassay-kits/800/600" className="rounded-2xl shadow-2xl border border-slate-100" alt="Bioassay Kits" />
