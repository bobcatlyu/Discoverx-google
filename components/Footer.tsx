    ...
    <footer className="bg-[#4B827E] text-white py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <p className="text-sm text-white/90 mb-2">地址：上海市浦东新区达尔文路 88 号</p>
          <p className="text-sm text-white/90 mb-2">电话：+86 (21) 5108 5588</p>
          <p className="text-sm text-white/90">邮箱：sales@discoverx.com.cn</p>
        </div>
      </div>
