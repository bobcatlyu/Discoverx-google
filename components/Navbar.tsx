...
const Navbar: React.FC<NavbarProps> = ({ currentPage, onNavigate }) => {
  ...
  const navItems: NavItem[] = [
    ...
    { 
      ...
      label: '定制开发',
      subItems: [
        { label: '细胞株定制构建', page: Page.CustomAssayDevelopment },
        ...
        <div className="flex items-center justify-between gap-4">
          ...
          <div className="flex items-center cursor-pointer shrink-0" onClick={() => onNavigate(Page.Home)}>
            <div className="flex items-center">
              <div className="bg-[#1C2C5E] p-1 rounded-sm mr-2">
              ...
              <span className="text-xl md:text-2xl font-bold text-[#1C2C5E] tracking-tight">eurofins</span>
              <div className="h-6 md:h-8 w-[1px] bg-slate-300 mx-2 md:mx-3 hidden xs:block"></div>
              <span className="text-xs md:text-sm font-semibold text-[#8C8EB2] uppercase tracking-wider hidden xs:block">DiscoverX</span>
            </div>
          </div>
